...
<input type="hidden" id="apiServer" name="apiServer" value="http://129.204.180.44/video"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://47.107.166.147/mvc"/>
